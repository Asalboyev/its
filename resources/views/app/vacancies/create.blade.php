                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="date" name="data" class="form-control" value="{{ old('date') }}" placeholder="{{ date('d-m-Y') }}" data-flatpickr='{"dateFormat": "d-m-Y"}' />
                                </div>
                                <div class="form-group">
                                    <label for="date" class="form-label">Цена</label>
                                    <input type="text" id="date" name="price" class="form-control" value="{{ old('price') }}" placeholder="Цена..."  />
                                </div>
                                <div class="form-group">
                                    <!-- Dropzone -->
